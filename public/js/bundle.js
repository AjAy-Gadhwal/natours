...
var stripe = Stripe('pk_test_9sorkhLDrfaA3ejdwtLZ28Mt');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Payment processing in successfully!');
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/users/".concat(type === 'password' ? 'updatePassword' : 'updateCurrentUser'),
              data: obj
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Detail Updated Successfully!"));
            }
...
if (accountForm) {
  accountForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(formData, 'account');
  });
}
